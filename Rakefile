...
desc 'Generate documentation for the shipping_times extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'ShippingTimesExtension'
...
desc 'Test the shipping_times extension.'
...
namespace :test do
  desc 'Functional test the shipping_times extension.'
  ...
  desc 'Unit test the shipping_times extension.'
